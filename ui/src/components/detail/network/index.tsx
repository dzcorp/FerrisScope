...
export function ServiceSummary(props: {
  ...
  if (state.kind === "loading")
    return (
      <Frame t={t}>
        <Loading t={t} label="Loading service…" inline />
      </Frame>
    );
  if (state.kind === "error")
...
export function EndpointsSummary(props: {
  ...
  if (state.kind === "loading")
    return (
      <Frame t={t}>
        <Loading t={t} label="Loading endpoints…" inline />
      </Frame>
    );
  if (state.kind === "error")
    return <ErrorBlock t={t} message={state.message} />;
...
export function EndpointSliceSummary(props: {
  ...
  if (state.kind === "loading")
    return (
      <Frame t={t}>
        <Loading t={t} label="Loading endpoint slice…" inline />
      </Frame>
    );
  if (state.kind === "error")
    return <ErrorBlock t={t} message={state.message} />;
...
export function IngressSummary(props: {
  ...
  if (state.kind === "loading")
    return (
      <Frame t={t}>
        <Loading t={t} label="Loading ingress…" inline />
      </Frame>
    );
  if (state.kind === "error")
    return <ErrorBlock t={t} message={state.message} />;
...
export function IngressClassSummary(props: {
  ...
  if (state.kind === "loading")
    return (
      <Frame t={t}>
        <Loading t={t} label="Loading ingress class…" inline />
      </Frame>
    );
  if (state.kind === "error")
    return <ErrorBlock t={t} message={state.message} />;
...
export function NetworkPolicySummary(props: {
  ...
  if (state.kind === "loading")
    return (
      <Frame t={t}>
        <Loading t={t} label="Loading network policy…" inline />
      </Frame>
    );
  if (state.kind === "error")
    return <ErrorBlock t={t} message={state.message} />;
