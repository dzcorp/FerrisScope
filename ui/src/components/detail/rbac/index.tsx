...
export function ServiceAccountSummary(props: {
  ...
  if (state.kind === "loading")
    return (
      <Frame t={t}>
        <Loading t={t} label="Loading service account…" inline />
      </Frame>
    );
  if (state.kind === "error")
...
export function RoleSummary(props: {
  ...
  if (state.kind === "loading")
    return (
      <Frame t={t}>
        <Loading t={t} label="Loading role…" inline />
      </Frame>
    );
  if (state.kind === "error")
    return <ErrorBlock t={t} message={state.message} />;
...
export function ClusterRoleSummary(props: {
  ...
  if (state.kind === "loading")
    return (
      <Frame t={t}>
        <Loading t={t} label="Loading cluster role…" inline />
      </Frame>
    );
  if (state.kind === "error")
    return <ErrorBlock t={t} message={state.message} />;
...
export function RoleBindingSummary(props: {
  ...
  if (state.kind === "loading")
    return (
      <Frame t={t}>
        <Loading t={t} label="Loading role binding…" inline />
      </Frame>
    );
  if (state.kind === "error")
    return <ErrorBlock t={t} message={state.message} />;
...
export function ClusterRoleBindingSummary(props: {
  ...
  if (state.kind === "loading")
    return (
      <Frame t={t}>
        <Loading t={t} label="Loading cluster role binding…" inline />
      </Frame>
    );
  if (state.kind === "error")
    return <ErrorBlock t={t} message={state.message} />;
