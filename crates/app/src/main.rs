...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::helm_rollback_cmd,
            commands::helm_storage_probe_cmd,
            ...
            commands::resolve_object_statuses_cmd,
            commands::apply_resource_cmd,
            commands::merge_patch_resource_cmd,
            commands::gitops_run_cmd,
            commands::delete_resource_cmd,
            commands::trigger_cron_job_cmd,
            commands::rerun_job_cmd,
            commands::list_jobs_for_cron_job_cmd,
